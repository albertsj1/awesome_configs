...
mygmail = widget({ type = "textbox", align = "right" })
mygmail.text = "<b><small> gmail </small></b>"

myemail = widget({ type = "textbox", align = "right" })
myemail.text = "<b><small> email </small></b>"
